    ...
    <div>
        ...
        >
          <VictoryLine
            ...
            data={PeerConnectionsRTCInboundRTPVideoStream_PacketsLostMin}
          />
            <VictoryLine
            style={{
              data: { stroke: "#c43a31" },
            ...
            data={PeerConnectionsRTCInboundRTPVideoStream_PacketsLostAvg}
          />
              <VictoryLine
            style={{
              data: { stroke: "#c43a31" },
            ...
            data={PeerConnectionsRTCInboundRTPVideoStream_PacketsLostMax}
          />
        </VictoryChart>
